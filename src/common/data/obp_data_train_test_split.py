...
from common.data.obp_data_partial_extraction import extract_partial_obp_data
...
class ObpDataTrainTestSplit:
    ...
    def set_params(self, test_size=0.25, random_state=None, stratify=None):
        ...
        self.indices_train, self.indices_test = train_test_split(indices, test_size=self.test_size,
    ...
    def get_train_test_data(self):
        ...
        self.train_batch_bandit_feedback = extract_partial_obp_data(batch_bandit_feedback=self.batch_bandit_feedback,
                                                                    index=self.indices_train)
        self.test_batch_bandit_feedback = extract_partial_obp_data(batch_bandit_feedback=self.batch_bandit_feedback,
